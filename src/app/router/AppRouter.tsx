        ...
        {  isAunteticacion ? (
          <Route path="/" element={<Layout />}>
            ...
            <Route path="/productos" element={<ProductoPage />}>
              ...
              <Route
                path="combinacion-receta"
                element={<CombinacionRecetaPage />}
              />
            </Route>
            ...
            <Route
              path="/comision/registro/receta"
              element={<RegistroSinComisionReceta />}
            />
            <Route
              path="/comision/registro/producto"
              element={<RegistroSinComisionProducto />}
            />
            <Route
              path="/comision/gestion/receta"
              element={<CombinacionRecetaPage />}
            />
            <Route
              path="/comision/gestion/servicio"
              element={<ComisionServicioPage />}
            />
            <Route
              path="/comision/gestion/servicio/sin-comision"
              element={<ComisionServicioSinComisionPage />}
            />
            <Route
              path="/cargar/comision/servicio"
              element={<CargarComisionServicioPage />}
            />
            <Route
              path="/comision/gestion/servicio/sin-comision/registro"
              element={<RegistarComisionServicioPage />}
            />
            <Route
              path="/comision/gestion/producto"
              element={<ComisionProductoPage />}
            />
            <Route
              path="/comision/gestion/producto/gafas"
              element={<ComisionGafasPage />}
            />
            <Route
              path="/comision/gestion/producto/montura"
              element={<ComisionMonturaPage />}
            />
            <Route
              path="/comision/gestion/producto/lente-contacto"
              element={<ComisionLenteContactoPage />}
            />
            <Route
              path="/comision/gestion/producto/sin-comision/gafas"
              element={<SinComisionGafasPage />}
            />
            <Route
              path="/comision/gestion/producto/sin-comision/montura"
              element={<SinComisionMonturaPage />}
            />
            <Route
              path="/comision/gestion/producto/sin-comision/lente-contacto"
              element={<SinComisionLenteContactoPage />}
            />
            <Route
              path="/cargar/combinaciones"
              element={<CargarCombinacionesPage />}
            />
            <Route
              path="/cargar/comision/producto"
              element={<CargarComisionProductoPage />}
            />
            <Route
              path="/actualizar/combinaciones"
              element={<ActualizarComisionesPage />}
            />
