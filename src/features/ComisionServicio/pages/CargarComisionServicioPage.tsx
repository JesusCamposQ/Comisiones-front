...
import { cargarSinComisionServicio } from "../services/cargarSinComisionServicio"
import toast, { Toaster } from "react-hot-toast"

export default function CargarComisionServicioPage() {
        ...
        if (response.status === 200) {
            toast.success(
              <div className="flex items-center gap-2">
                ...
                <span>Comisiones de servicio registradas</span>
              </div>
            )
