...
export const UsuarioPage = () => {
  ...
  const usuarioActuales = usuario?.filter(
    (usuario) => usuario.flag != "eliminado"
  );
  const handleUpdate = (id: string) => {
    setMostrarEdicion(!monstrarEdicion)
    setActualizar(!actualizar)
    const usuarioEditar = usuarioActuales?.find(
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-teal-50 to-white p-4 md:p-8">
      ...
      <Card className="mx-auto shadow-lg border-teal-100 p-0">
        ...
        <CardContent className="p-4">
          ...
          <div className="rounded-lg border overflow-hidden">
            <Table>
              <TableHeader className="bg-teal-100">
                <TableRow>
                  <TableHead className="text-teal-800 font-semibold">
                    Nombres
                  </TableHead>
                  <TableHead className="text-teal-800 font-semibold">
                    Apellidos
                  ...
                  <TableHead className="text-teal-800 font-semibold text-center">
                    Acciones
                  </TableHead>
                </TableRow>
              </TableHeader>
          ...
          {
            monstrarEdicion &&  <EditarUsuarioPage
          ...
          <div className="mt-6 text-center text-sm text-teal-600">
            Mostrando {usuarioActuales?.length} usuarios de un total de{" "}
            {usuarioActuales?.length}
          </div>
        </CardContent>
      </Card>
    </div>
